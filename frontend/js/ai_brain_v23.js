/* =========================================================
   ...
   Bilingual compatibility layer for V26–V30
...
(function (RG23) {
    ...
    const Brain = {
            ...
            window.addEventListener(
                ...
                () => {
                    ...
                    try {
                        ...
                        console.warn(
                            "RG23 Brain: language refresh skipped.",
                            error
                        );
        ...
        calculateFinalRisk(city) {
            ...
            risk +=
                normalized.weatherScore *
                0.35;

            risk +=
                normalized.floodIndex *
                0.30;
        ...
        destroy() {
            ...
            if (this.map) {
                ...
                try {
                    ...
                    console.warn(
                        "RG23 Brain: map destroy skipped.",
                        error
                    );
...
window.addEventListener(
    ...
    async () => {
        ...
        try {
            ...
            /*
             * إذا كان V30 موجودًا،
             * يكون الـ Orchestrator هو المتحكم الرئيسي.
             */
...
window.getLatestNationalAnalysis =
    function () {
...
window.getLatestNationalDecision =
    function () {
...
window.startNationalAutoRefresh =
    function () {
...
window.stopNationalAutoRefresh =
    function () {
...
console.log(
    ...
    "%cRainGuard AI Base Brain V23.3 (V30 Bilingual Compatible)",
