...
===========================================================
 ...
 Responsibilities:
 - Create central modular engine registry
 - Resolve the current module directory
 - Load modules in dependency order
 - Prevent duplicate script loading
 - Expose readiness Promise
 - Preserve RainGuard AI V32 global compatibility
===========================================================
*/
...
(function initializeRainArrivalModularEngine(global) {
    ...
    const BUILD =
        "rainguard-v32-phase38m-modular-bootstrap-loader";
...
},
{
    ...
    if (
        engine.config.autoInitialize
    ) {
        engine.initialize();
    }

    console.log(
        "[RainGuard AI V32] Phase 38M Bootstrap loaded.",
        {
            version:
                VERSION,
