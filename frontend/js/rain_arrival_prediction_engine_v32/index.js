...
===========================================================
 ...
 C2 -> IndexedDB Persistent Temporal History
 C3 -> Authoritative Stable Identity Cross-Reload Recovery
===========================================================
*/
...
(function initializeRainArrivalModularEngine(global) {
    ...
    =======================================================
     IMPORTANT
     MODULE_LOAD_ORDER is sequential.

     C2 MUST load before C3 because C3 reuses the
     authoritative IndexedDB temporal-history database
     created/maintained by C2.
    =======================================================
    */
    ...
    const MODULE_LOAD_ORDER = Object.freeze([
        {
            name: "utils",
            file: "utils.js",
            requiredGlobal: "RainArrivalUtilsV32"
        },

        {
            name: "trackStore",
            file: "track_store.js",
            requiredGlobal: "RainArrivalTrackStoreV32"
        },

        {
            name: "cache",
            file: "cache.js",
            requiredGlobal: "RainArrivalCacheV32"
        },
...

        {
            ...
            requiredGlobal: "RainArrivalMotionEngineV32"
        },

        {
            name: "replayEngine",
            file: "replay_engine.js",
            requiredGlobal: "RainArrivalReplayEngineV32"
        },

        {
            name: "candidateEngine",
            file: "candidate_engine.js",
            requiredGlobal: "RainArrivalCandidateEngineV32"
        },
        ...
        */
        ...
        {
            name: "indexedDBPersistentTemporalHistory",
            file:
        ...
        ===================================================
         Phase C3
         Authoritative Stable Identity Recovery

         MUST remain immediately after C2.
        ===================================================
        */

        {
            name: "indexedDBAuthoritativeIdentityRecovery",
            file:
...

        {
            ...
            requiredGlobal: "RainArrivalOrchestratorV32"
        }
    ]);
    ...
    const DEFAULT_CONFIG = Object.freeze({
        ...
        /*
         Do not continue if C2/C3 fails.
         Identity recovery is now part of the authoritative
         runtime chain.
        */
    ...
    function resolveBasePath() {
        ...
        if (currentScript?.src) {
            try {
                ...
                console.warn(
                    "[RainArrival Bootstrap] Failed to resolve current script path.",
                    error
                );
            }
        }
        ...
        const matchingScript =
            Array.from(document.scripts || [])
                ...
                .find(script =>
                    String(script.src || "")
                        .includes(
                            "rain_arrival_prediction_engine_v32/index.js"
                        )
                );
    ...
    class RainArrivalModularEngine {
        ...
        register(name, module) {
            ...
            /*
             Publish module into the compatibility registry
             immediately as well.
            */
            ...
            global.RainGuardAI.V32
                .rainArrivalModules[name] = module;
            ...
            if (this.config.debug) {
                ...
                console.log(
                    "[RainArrival Bootstrap] Module registered:",
                    name
                );
            }
        ...
        unregister(name) {
            ...
            if (
                ...
                delete global.RainGuardAI.V32
                    .rainArrivalModules[name];
            }
                        ...
                        global.setInterval(
                            () => {
                                ...
                                if (
                                    ...
                                    reject(
                                        new Error(
                                            `GLOBAL_NOT_AVAILABLE: ${globalName}`
                                        )
                                    );
                                }
        ...
        loadScript(definition) {
            ...
            /*
             If the module already exists globally,
             register it without reloading the file.
            */
        ...
        async loadModules() {
            ...
            try {
                ...
                /*
                 Sequential await is intentional.

                 This guarantees:

                 C2 finishes loading before C3.

                 C3 therefore sees the C2 bridge and the
                 authoritative IndexedDB database.
                */

                for (
                    const definition
                    of MODULE_LOAD_ORDER
                ) {
                ...
                this.lastResult =
                    {
                        ...
                        /*
                         Explicit C2/C3 readiness fields.
                        */
                        ...
                        authoritativeIdentityRecoveryReady:
                            Boolean(
                                global
                                    .RainGuard39A15F6N4B1B3C3BridgeV39
                            ),
                ...
                console.log(
                    "[RainGuard AI V32] Modular Rain Arrival Engine ready.",
                    this.lastResult
                );
                ...
                console.error(
                    "[RainGuard AI V32] Modular loading failed.",
                    this.lastResult
                );
        ...
        publishCompatibilityApi() {
            ...
            /*
             Keep already registered modules.
            */
            ...
            /*
             Expose authoritative persistence bridges
             through the runtime API.
            */

            runtime.temporalHistory =
                global
                    .RainGuard39A15F6N4B1B3C2BridgeV39 ||
                null;
        ...
        getDiagnostics() {
            ...
            return {
                ...
                /*
                 C2/C3 diagnostic visibility.
                */

                temporalHistoryBridgeAvailable:
                    Boolean(
                        global
                            .RainGuard39A15F6N4B1B3C2BridgeV39
                    ),

                authoritativeIdentityRecoveryBridgeAvailable:
                    Boolean(
                        global
                            .RainGuard39A15F6N4B1B3C3BridgeV39
                    ),
        ...
        printModules() {
            ...
            const rows =
                MODULE_LOAD_ORDER.map(
                    definition => {

                        const state =
                            this.moduleStates.get(
                                definition.name
                            ) || {};
    ...
    */
    ...
    console.log(
        "[RainGuard AI V32] Phase 39A-15F6N4B1B3C3 Bootstrap loaded.",
        {
            version:
                VERSION,
