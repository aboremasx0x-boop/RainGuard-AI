...
(function initializeRainGuardLegacyLoopController(global) {
    ...
    const NAME =
        "RainGuardLegacyLoopControllerV39";
    ...
    const BUILD =
        "rainguard-v39-legacy-loop-controller";
    ...
    /*
     * Targets are based on the modules repeatedly observed
     * in the RainGuard Console.
     */
    const TARGETS =
        Object.freeze([

            {
                ...
                paths: [
                    "StormEntityCollector",
                    "RainGuardAI.V32.StormEntityCollector",
                    "RainGuardAI.V32.stormEntityCollector",
                    "RainArrivalEngineV32.StormEntityCollector",
                    "RainArrivalEngineV32.stormEntityCollector"
                ]
            },

            {
                ...
                paths: [
                    "StormTrackStoreBridge",
                    "RainGuardAI.V32.StormTrackStoreBridge",
                    "RainGuardAI.V32.stormTrackStoreBridge",
                    "RainArrivalEngineV32.StormTrackStoreBridge",
                    "RainArrivalEngineV32.stormTrackStoreBridge"
                ]
            },

            {
                ...
                paths: [
                    "LiveStormExportBridge",
                    "RainGuardAI.V32.LiveStormExportBridge",
                    "RainGuardAI.V32.liveStormExportBridge",
                    "RainArrivalEngineV32.LiveStormExportBridge",
                    "RainArrivalEngineV32.liveStormExportBridge"
                ]
            },

            {
                ...
                displayName:
                    "StormEntitySourceAdapter",

                paths: [
                    "StormEntitySourceAdapter",
                    "RainGuardAI.V32.StormEntitySourceAdapter",
                    "RainGuardAI.V32.stormEntitySourceAdapter",
                    "RainArrivalEngineV32.StormEntitySourceAdapter",
                    "RainArrivalEngineV32.stormEntitySourceAdapter"
                ]
            },

            {
                ...
                paths: [
                    "CandidateScoring",
                    "RainGuardAI.V32.CandidateScoring",
                    "RainGuardAI.V32.candidateScoring",
                    "RainArrivalEngineV32.CandidateScoring",
                    "RainArrivalEngineV32.candidateScoring"
                ]
            }
        ]);
    ...
    /*
     * Only execution-like methods are wrapped.
     * Lifecycle methods such as start/stop are NOT wrapped.
     */
        ...
        canInvoke(
            ...
            if (
                ...
                return {
                    ...
                    reason:
                        "LEGACY_TARGET_TEMPORARILY_BLOCKED"
                };
            }
            ...
            if (
                ...
                return {
                    ...
                    reason:
                        "LEGACY_EXECUTION_ALREADY_RUNNING"
                };
            }
